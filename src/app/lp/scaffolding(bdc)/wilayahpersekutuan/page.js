...
import FormblastingScaffoldingWilayahPersekutuan from '@/components/lp/scaffolding(bdc)/FormblastingScaffoldingWilayahPersekutuan'
  ...
  return (
    <div>
      ...
      <section>
        ...
        <section>
        <div className="">
          <FormblastingScaffoldingWilayahPersekutuan/>
        </div>
      </section>
      <div className=" py-2 md:py-4 lg:py-8"></div>
      <section>
