  ...
  return (
    ...
    <section>
      <div className=" ">
        <div className="justify-center grid ">
          ...
          {/* <h style={{color: '#0046AA', letterSpacing:'3.5px', fontFamily: '"Anton", Sans-serif', fontSize: '52px', textAlign: 'center'}}>BASIC ERECTOR</h> */}
    ...
    <section>
      ...
      <a href="#target-section" 
        ...
        smooth={true}
        duration={500} 
        className="flex pl-5 p-3 cursor-pointer">
        <span className="text-white text-xl">Dapatkan maklumat lebih lanjut</span>
        <svg
          width="20"
          height="28"
          viewBox="0 0 15 15"
    ...
    <section id="target-section">
      <div className="w-full bg-slate-300 p-4 rounded-sm">
        <div className=" grid justify-center">
          <div className="p-2">
